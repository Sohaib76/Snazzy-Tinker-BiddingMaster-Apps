      ...
      <View style={styles.container}>
        ...
        <View style={styles.dropdownContainer}>
          <Picker
            ...
            <Picker.Item label="Value 1" value="1" />
            <Picker.Item label="Value 2" value="3" />
            <Picker.Item label="Value 3" value="5" />
            <Picker.Item label="Value 4" value="7" />
            <Picker.Item label="Value 5" value="15" />
          </Picker>
        </View>
      </View>
    );
